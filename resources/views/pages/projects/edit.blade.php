            ...
            <div class="form__wrapper">
                    ...
                    <div class="form__row">
                        ...
                        <div class="field">
                            <div class="field field--column">
                                ...
                                <input type="text" name="paper_type_cover" value="{{$project->paper_type_cover}}" @can('isSeller') readonly @endcan>
                            ...
                            <div class="field field--column">
                                ...
                                <input type="text" name="color_cover" value="{{$project->color_cover}}" @can('isSeller') readonly @endcan>
                                @error('color_cover')
                                    <span class="form__message" role="alert">
                                        <small>{{ $message }}</small>
                                    </span>
                ...
                <fieldset class="form__section">
                    <div class="section__block">
                        <h3>{{ __('Extra') }}</h3>
                        <div class="field field--column">
                            <label class="field__label" for="comments">{{ __('Opmerkingen') }}</label>
