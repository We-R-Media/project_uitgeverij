...
@section('content')
    <div class="form__wrapper">
        <div class="form__top">
            ...
            <h3 class="heading--margin-none text--primary">{{ __('Wachtwoord vergeten') }}</h3>
        </div>
        <div class="form__box">
            <div class="form__instruction">
                {{ __('Vul je e-mailadres in en ontvang een herstelkoppeling om een nieuw wachtwoord te kiezen.') }}
            </div>
            ...
            <div class="form__bottom">
                <a class="link link--action" href="{{ route('login') }}">
                    {{ __('Inloggen') }}
                </a>
            </div>
        </div>
