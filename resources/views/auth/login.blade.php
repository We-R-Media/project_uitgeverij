...
@section('content')
    <div class="form__wrapper">
        <div class="form__top">
            ...
            <h3 class="heading--margin-none text--primary">{{ __('Welkom') }}</h3>
            <p class="heading--medium">{{ __('U moet inloggen om verder te gaan') }}</p>
        </div>
        <div class="form__box">
            <form method="POST" action="{{ route('login') }}">
                ...
                <fieldset class="fields">
                    ...
                    <div class="form__row">
                        <div class="field">
                            <label class="field__checkbox" for="remember">
            ...
            @if (Route::has('password.request'))
                <div class="form__bottom">
                    <a class="link link--action" href="{{ route('password.request') }}">
